            ...
            <Card aria-labelledby="submit-property-form" className="mx-auto p-6">
                <Formik
                    initialValues={{
                        ...
                        price: '500',
                        area: '10',
                        parking: true, // Set to false for checkbox
                        vacant: true, // Set to false for checkbox
                        nearby: '23',
                        description: 'rfo',
                        sale: '12',
                        badge: '21',
                        ...
                        unit_floor: '1232',
                        submitted_by: 'asdd',
                        commission: true, // Set to false for checkbox
                        terms: 'true',
                        title: 'asdfadfadf',
                        lease: 'six-months"',
                        turnover: '2022-10-10',
                        ...
                        acknowledgment: true, // Set to false for checkbox
                    }}
