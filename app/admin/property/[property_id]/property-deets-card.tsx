...
const PropertyDetails: React.FC<PropertyDetailsProps> = ({ property_id }) => {
    const { data, error, isLoading } = useSWR(`${process.env.NEXT_PUBLIC_BASE_URL}/api/properties/${property_id}`, fetchWithToken);
        ...
        <div className="p-4">
            <Card className="max-w-4xl mx-auto">
                <CardHeader className="flex justify-between items-center">
                    ...
                    <Chip color={property.status === "For Rent" ? "primary" : "success"}>
                        {property.status}
                    </Chip>
                </CardHeader>
                <Divider />
